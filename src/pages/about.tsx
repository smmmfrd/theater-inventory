...
export default function AboutPage() {
  return (
    <>
      <Head>
        <title>About | Fake Theater</title>
      </Head>
      <RegularLayout>
        <section className="flex max-w-md flex-col gap-8 px-12 sm:mx-auto [&>*]:leading-7">
          ...
          <p>
            This website is a fake movie theater modeled after my local
            theater's site, where they have live updating ticket sales.
          </p>
          <p>
          ...
          <p>
            ...
            for it, from 2 to (currently) 15% of the maximum number of seats
            left.
          </p>
        </section>
      </RegularLayout>
